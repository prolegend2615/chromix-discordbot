...
export const dbPromise = (async () => {
  ...
  await db.exec("CREATE TABLE IF NOT EXISTS afk_status (user_id TEXT NOT NULL, guild_id TEXT NOT NULL DEFAULT '', reason TEXT NOT NULL DEFAULT 'None', created_at INTEGER NOT NULL, PRIMARY KEY(user_id, guild_id))");
